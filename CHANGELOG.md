...
All notable changes to **flowguard** will be documented here. This project follows [Semantic Versioning](https://semver.org/) — once we hit 1.0. Until then, minor versions may include breaking changes; check the upgrade notes below.

## [0.2.0] — 2026-04-21

### Added

- **`PostgresStorage`** adapter (`flowguard/storage/postgres`)
  - State stored in `flowguard_states` (JSONB)
...
- **`RedisStorage`** adapter (`flowguard/storage/redis`)
